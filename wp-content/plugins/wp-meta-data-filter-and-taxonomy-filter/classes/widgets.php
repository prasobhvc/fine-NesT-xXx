...
//Widget Setup
    function __construct()
    {
        ...
        parent::__construct(__CLASS__, __('MDTF', 'meta-data-filter'), array(
            'classname' => __CLASS__,
            'description' => __('Meta Data Filter - search and filter data by taxonomies and meta fileds.', 'meta-data-filter')
                )
        );
    }
...
//Widget Setup
    function __construct()
    {
        parent::__construct(__CLASS__, __('MDTF Taxonomies only', 'meta-data-filter'), array(
            'classname' => __CLASS__,
            'description' => __('MDTF Taxonomies - search and filter data by taxonomies only.', 'meta-data-filter')
                )
        );
    }
...
//Widget Setup
    function __construct()
    {
        ...
        parent::__construct(__CLASS__, __('MDTF single page', 'meta-data-filter'), array(
            'classname' => __CLASS__,
            'description' => __('MDTF single post data', 'meta-data-filter')
                )
        );
    }
