jQuery(function () {
    ...
    jQuery('.mdf_admin_flter_item_box_toggle').life('click', function () {
    ...
    jQuery('.mdf_textinput_tag_selector').life('change', function () {
    ...
    jQuery('.mdf-section-title-button').life('click', function () {
        if (mdf_section_flag) {
            return;
        }
        mdf_section_flag = 1;
