                        ...
                        <?php if ($item['type'] == 'slider'): ?>
                            ...
                            <td>
                                ...
                                <div class="mdf_input_container mdf_slider_<?php echo $key ?>">
                                    ...
                                    <h5 class="data-filter-section-title mdf_range_slider_header" style="margin-bottom: 4px;"><span class="mdf_range_slider_header_txt"><?php _e($item['name']) ?>:&nbsp;</span><span class="mdf_range"><input type="text" value="<?php echo $min ?>" class="mdf_range_min" data-slider-id="ui_slider_item_<?php echo $uid ?>" />
                        ...
                        <?php if ($item['type'] == 'select'): ?>
                            <?php if (!empty($item['select'])): ?>
                                ...
                                <td>
                                    <div class="mdf_input_container">
                    <?php if ($item['name']{0} !== '~'): ?>
                                            <h5 class="data-filter-section-title" style="margin-bottom: 4px;"><?php _e($item['name']) ?>:&nbsp;<?php if (!empty($item['description'])): ?>
                                                    <span class="mdf_tooltip" title="<?php echo str_replace('"', "'", __($item['description'])); ?>">
                                                        <img src="<?php echo $icon ?>" alt="help" />
                                                    </span>
                                            <?php endif; ?>
        ...
        <?php if ($widget_options['hide_meta_filter_values'] != 'true'): ?>
                ...
                <?php endif; ?>
                                                ...
                                                <?php endforeach; ?>
                                                    ...
                                                    <?php if ($li_counter == 0): ?>
                                                    <li>
                                                    <?php _e("no available items", 'meta-data-filter') ?>
                                                    </li>
            <?php endif; ?>
