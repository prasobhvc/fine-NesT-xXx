    ...
    <div class="widget widget-meta-data-filter">
        ...
        <?php if (isset($_REQUEST['meta_data_filter_count']) AND $instance['show_found_totally'] == 'true'): ?>
            <i class="mdf_widget_found_count">
                <?php
                $show_items_count_text = sprintf(__('Found <span>%s</span> items', 'meta-data-filter'), $_REQUEST['meta_data_filter_count']);
        ...
        <form method="get" action="" id="meta_data_filter_<?php echo $uniqid ?>" data-search-url="<?php echo $search_url ?>" data-unique-id="<?php echo $uniqid ?>" data-slug="<?php echo $instance['meta_data_filter_slug'] ?>" data-sidebar-name="<?php echo $sidebar_name ?>" data-sidebar-id="<?php echo $sidebar_id ?>" data-widget-id="<?php echo $widget_id ?>" class="mdf_search_form mdf_widget_form <?php if ($instance['ajax_items_recount'] AND ! $instance['act_without_button']): ?>mdf_ajax_auto_recount<?php endif; ?> <?php if ($instance['ajax_items_recount'] AND $instance['act_without_button'] != 'true' AND $ajax_results): ?>mdf_ajax_content_redraw<?php endif; ?>">
            ...
            <?php if ($instance['show_reset_button'] AND self::is_page_mdf_data()): ?>                
                <div class="mdf_reset_button_container">
                    ...
                    ?>
                    <input type="button" href="<?php echo(empty($reset_link) ? '#' : $reset_link) ?>" class="button mdf_button mdf_reset_button" value="<?php _e('Reset', 'meta-data-filter') ?>" /><br />
                </div>
            <?php endif; ?>
