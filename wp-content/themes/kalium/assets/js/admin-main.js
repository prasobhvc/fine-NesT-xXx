;(function($, window, undefined)
{
	...
	{
		// Portfolio
		var $portfolio_item_type = $(".post-type-portfolio .postbox-container #acf-field-item_type");
		
		if($portfolio_item_type.length)
		{	
			var $item_type_images    	= $('<div class="portfolio-item-type-images"></div>'),
			...
			if(is_editing)
			{
				$warning_container.append('<strong>Note:</strong> You are currently using <strong>'+default_text+'</strong> type. If you change this portfolio type you may loose some of the current settings.');
			}
			else
			{
