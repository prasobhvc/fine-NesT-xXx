...
$is_local_ip = isset( $_SERVER['SERVER_ADDR'] ) && ( $_SERVER['SERVER_ADDR'] == '127.0.0.1' || $_SERVER['SERVER_ADDR'] == '::1' );
$is_local_site = $is_local_ip && ABSPATH == '/Applications/MAMP/htdocs/kalium/wp/';
	...
	register_field_group(array (
		...
		'fields' => array (
			array (
				...
				'type' => 'text',
				'instructions' => 'Set the correct video resolution to make it fit inside the container. Default is used if empty: 16:9<br />
				...
				'layouts' => array (
					...
					array (
						...
						'sub_fields' => array (
							...
							array (
								'key' => 'field_54ccad7e09b55',
								'label' => 'Player Options',
								'name' => 'player_options',
								'type' => 'select',
								'instructions' => 'Select video player',
								'column_width' => '',
								'choices' => array (
									'default' => 'Default YouTube player',
									'theme' => 'Theme Styled Player',
									'minimal' => 'Minimal Player',
								),
								'default_value' => 'default',
								'allow_null' => 0,
								'multiple' => 0,
