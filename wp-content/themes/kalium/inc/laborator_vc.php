...
if ( is_array( get_option( 'active_plugins' ) ) && ! in_array( 'js_composer/js_composer.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) || ! function_exists( 'vc_add_params' ) ) {
	return;
}
