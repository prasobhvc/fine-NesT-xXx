...
$of_options[] = array(	"desc"   	=> "Activate sticky menu immediately on first scroll",
						"id"   		=> "header_sticky_sticky_immediate",
						"std"   	=> 0,
						"on"  		=> "Yes",
						"off"  		=> "No",
						"type"   	=> "switch",
...
$of_options[] = array( 	"desc" 		=> "Support for post formats (listing page)",
						"id" 		=> "blog_post_formats",
						"std" 		=> 1,
						"type" 		=> "checkbox"
				);

$of_options[] = array( 	"desc" 		=> "Lazy loading for thumbnails (listing page)",
...
$of_options[] = array( 	"desc" 		=> "Use animated eye on item hover",
...
$of_options[] = array( 	"desc" 		=> "Disable lightbox for portfolio items",
...
if ( $portfolio_prefix_url_slug_placeholder )  {
	...
	$of_options[] = array( 	"desc"		=> "Custom portfolio item URL prefix<br><small>Note: When you change this setting you need to <a href=\"" . admin_url( 'themes.php?page=laborator_docs#flush-rewrite-rules' ) . "\" target=\"_blank\">flush rewrite rules</a>.</small>",
...
$of_options[] = array( 	"desc" 		=> "Portfolio items per page for this type<br><small>Note: To display all portfolio items in single page enter <strong>-1</strong> value.</small>",
...
$of_options[] = array( 	"desc" 		=> "Thumbnail size for this type<br><small>If you change dimensions you must <a href=\"admin.php?page=laborator_docs#regenerate-thumbnails\" target=\"_blank\">regenerate thumbnails</a>.</small>",
...
$of_options[] = array( 	"desc" 		=> "Category Image Size <br /><small>If you change dimensions you must <a href=\"admin.php?page=laborator_docs#regenerate-thumbnails\" target=\"_blank\">regenerate thumbnails</a>.</small>",
...
$of_options[] = array(  "desc"   	=> "If skin is showing 404 error and not being applied then check this box.",
