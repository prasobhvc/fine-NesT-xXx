	...
	<div class="page-container">
    	<div class="single-portfolio-holder portfolio-type-2<?php when_match($is_centered, 'portfolio-centered-layout alt-six', 'alt-four'); ?>">
	    	...
	    	<div class="<?php echo implode(' ', $fi_classes); ?>">
				...
				<?php if($caption): ?>
				<div class="caption">
    				<?php echo nl2br(lab_esc_script($caption)); ?>
    			</div>
				<?php endif; ?>
			</div>
			<?php
    		...
    		<div class="details row">
				...
				<?php if($share_and_like_position == 'before') include locate_template('tpls/portfolio-single-like-share.php'); ?>
			...
			<?php if($share_and_like_position == 'after') include locate_template('tpls/portfolio-single-like-share.php'); ?>
