...
if($blog_post_formats)
{
	switch($post_format)
	{
		case 'quote':
			...
			$format_content = $post_quote = laborator_extract_post_content('quote', true);
			break;
		...
		case 'video':
			...
			$format_content = $post_video = laborator_extract_post_content('video', true, $meta);
			break;
		...
		case 'audio':
			...
			$format_content = $post_audio = laborator_extract_post_content('audio', true, $meta);
			break;
	
		case 'link':
			$format_content = $post_link = laborator_extract_post_content('link', true);
			$hover_state = 'icon-basic-link';
			break;
	
		case 'image':
			$format_content = $post_image = laborator_extract_post_content('image', true);
