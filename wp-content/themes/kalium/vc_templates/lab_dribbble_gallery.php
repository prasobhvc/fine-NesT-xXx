...
<div class="<?php echo esc_attr($css_class) . vc_shortcode_custom_css_class($css, ' '); ?>">
	<div id="<?php echo esc_attr($dribbble_gallery_id); ?>" class="dribbble-container is-loading dribbble-<?php echo esc_attr($columns); ?>-columns" data-dribbble-user="<?php echo esc_attr($username); ?>" data-dribbble-count="<?php echo esc_attr($count); ?>">
