...
# start: modified by Arlind Nushi
if ( $full_width != 'lab-full-width' ) {
	$output = '<div class="container lab-vc-container">' . $output . '</div>';
}
...
$output = '<div class="lab-row-container ' . esc_attr( trim( $css_class ) ) . '" ' . implode( ' ', $lab_parallax_params ) . '>' . $output . '</div>';
# end: modified by Arlind Nushi
